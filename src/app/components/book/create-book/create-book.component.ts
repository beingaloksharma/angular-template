...
export class CreateBookComponent implements OnInit {
  ...
  constructor(
    ...
    //Get Languages
    this._commonService
      .get(this._constants.SERVER_URL + 'languages')
    ...
    //Get Keywords
    this._commonService
      .get(this._constants.SERVER_URL + 'keywords')
    ...
    //Get Countires
    this._commonService
      .get(this._constants.SERVER_URL + 'countries')
    ...
    //Get Publications
    this._commonService
      .get(this._constants.SERVER_URL + 'publications')
      .subscribe((res: string[]) => {
    ...
    if (this.bookForm.valid) {
      ...
      switch (this.dbOps) {
        case DBOps.Create:
          ...
          //call service
          this._commonService
            .post(this._constants.SERVER_URL + 'book', this.payload)
            .subscribe(
              (res: any) => {
                //Set Loader
        ...
        case DBOps.Update:
          ...
          //call service
          this._commonService
            .put(this._constants.SERVER_URL + 'book', this.payload)
            .subscribe(
              (res: any) => {
                //Set Loader
                this._loader.setLoading(true);
  ...
  private getBookDetailsForUpdate(id: number) {
    //call service
    this._commonService
      .get(this._constants.SERVER_URL + 'book/' + id)
      .subscribe(
        (res: any) => {
          //Set Loader
          this._loader.setLoading(true);
